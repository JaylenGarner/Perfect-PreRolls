...
const menuItems = [
  ...
  { page: "Newsletter", path: "/#sign_up_form" },
...
const cards = [
  ...
  },
  {
    ...
    body: "Produces perfectly packed pre-rolls quickly and easily doing multiple at a once with a cycle time ranging from .5 - 1.5 minutes",
